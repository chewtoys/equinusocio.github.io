...
module.exports = Object.freeze({
  ...
  COMMON_META: [
    ...
    { hid: 'ip:image', itemprop: 'image', content: 'https://equinsuocha.io/cover.jpeg' },
    { hid: 'og:type', property: 'og:type', content: 'website' },
    { hid: 'og:title', property: 'og:title', content: NAME },
    { hid: 'og:url', property: 'og:url', content: '' },
    { hid: 'og:site_name', property: 'og:site_name', content: NAME },
    { hid: 'og:image', property: 'og:image', content: `https://equinsuocha.io/cover.jpeg` },
  ...
  COMMON_SCRIPTS: [
    { src: '//instant.page/1.1.0', type: 'module', defer: true, integrity: 'sha384-EwBObn5QAxP8f09iemwAJljc+sU+eUXeL9vSBw1eNmVarwhKk2F9vBEpaN9rsrtp' }
  ]
})
