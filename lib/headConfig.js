...
module.exports = Object.freeze({
  ...
  COMMON_META: [
    ...
    { hid: 'name', itemprop: 'name', content: NAME },
    { hid: 'headline', itemprop: 'headline', content: `${NAME}, Frontend Developer` },
    { hid: 'description', itemprop: 'description', content: DESCRIPTION },
