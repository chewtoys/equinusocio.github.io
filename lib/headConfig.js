...
module.exports = Object.freeze({
  ...
  COMMON_META: [
    ...
    { name: 'pple-mobile-web-app-status-bar-style', content: 'default' },
    ...
    { hid: 'ip:image', itemprop: 'image', content: '/cover.jpg' },
    { hid: 'og:type', property: 'og:type', content: 'website' },
    { hid: 'og:title', property: 'og:title', content: NAME },
    { hid: 'og:url', property: 'og:url', content: '' },
    { hid: 'og:site_name', property: 'og:site_name', content: NAME },
    { hid: 'og:image', property: 'og:image', content: `https://equinsuocha.io/cover.jpg` },
